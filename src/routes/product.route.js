...
productRouter.post('/create-product',isAdmin,upload.array("images"),createProduct)
productRouter.get('/',getAllProduct)
productRouter.patch('/update-product/:id', isAdmin,upload.array("images"), updateProduct);
